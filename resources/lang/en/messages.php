...
return [
  ...
  // '' => '',
  // topbar
    'Pc-marine_name' => 'PC Marine (1992) Co., Ltd. ',
    'Manu_Home' => 'Home',
    'Manu_Story' => 'Story',
    ...
    'Services_Detail_Head_01' =>
    '<p>1. An oil tanker or liquid tanker (tanker) with a cargo capacity of 1700 tons to 2600 tons, consisting of 7 ships, namely:
    Pacific Marine, Ocean Marine, P.C. Marine, Kittiphon, KTP 3, KTP 4, Intermarine</p>
    <p>2. Cargo ship or marine steamship (Motor Barge) with a cargo capacity ranging from 1500 to 2400 tons, as described below:
    Sriwichai Navy 1, Sriwichai Navy 3, KTP 1, KTP</p>
    <p>3. Pontoon boat or tugboat with a cargo capacity ranging from 2100 to 2700 tons, namely
    PPN 1, PPN 2, PPN 3, PPN 4, PPN 5, PPN 6, PPN7, PPN8.</p>
    <p>From the experience of providing transportation services by sea, And with the trust of customers, PC Marine also provides a one-stop service for shipping by sea, namely, customs clearance (shipping) and customs clearance. boat (agent) to facilitate fast service for customers.</p>',

    'Services_Head_02' => 'Transportation service',
    'Services_Detail_Head_02' =>
    '<p>ใAt present, the company There has been a boat transportation service. In addition to palm oil, there are also other types of transportation to support the needs of customers. The types of transport are divided as follows:</p>
    <p>1. Domestic transportation There is a service to transport goods from manufacturing plants or warehouses to various destinations in the country.</p>
    <p>2. International transportationThere is a service to transport goods from the warehouse to the port of destination abroad.</p>
    <p>3. Foreign ship rental Cargo services are provided from the customer`s port to deliver the goods to the overseas destination port.</p>',
    ...
    'Story_2551_2' => 'On July 16, 2008, KTP Logistics Company Limited (KTP) was registered with an initial registered capital of 1 million baht to operate a water transport business.
        <p>DIM KTP was founded as First Idea Multimedia 2008 Co., Ltd., and later changed its name to Filter Oil Co., Ltd., and then to KTP Logistics Co., Ltd., respectively.</p>
        <p>Purchase two boats: KTP one and KTP two.</p>',
    // 2553
    ...
    'Services_sub_01' => '1. An oil tanker or liquid tanker (tanker) with a cargo capacity of 1700 tons to 2600 tons, consisting of 7 ships, namely: Pacific Marine, Ocean Marine, P.C. Marine, Kittiphon, KTP 3, KTP 4, Intermarine 2. Cargo ship or marine steamship (Motor Barge) with a cargo capacity ranging from 1500 to 2400 tons, as described below:
    Srivichai Navy 1, Srivichai Navy 3, KTP 1, KTP 2. 3. pontoon boat or tugboat with a cargo capacity of 2100 to 2700 tons, specifically PPN 1, PPN 2, PPN 3, PPN 4, PPN 5, PPN 6, PPN7, PPN8. From the experience of providing transportation services by sea, And with the trust of customers, PC Marine also provides a one-stop service for shipping by sea,
    ...
    'Services_sub_02' => 'At present, the company There has been a boat transport service. In addition to palm oil, there are also other types of transportation to support the needs of customers. The types of transport are divided as follows: 1. Domestic transportation There is a service to transport goods from manufacturing plants or warehouses to various destinations in the country.
    2. International transportationThere is a service to transport goods from the warehouse to the port of destination abroad. 3. Foreign ship rental Cargo services are provided from the customer`s port to deliver the goods to the overseas destination port.',
