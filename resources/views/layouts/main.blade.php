...
<head>
  ...
  <title> @lang('messages.Hero_Head') </title>
  ...
  <link href="assets/css/text-color.css" rel="stylesheet">
    ...
    <div class="preloader">
      <div class="sk-cube-grid">
        <div class="sk-cub"  style="text-align: center">
            <img class="expanding-image" src="assets/images/logo/pc-marine-logo.svg" alt="Loading Image">
            <h3><font style="color: #30CCCE">P</font style="color: #318DAD"><font style="color: #324487">C</font><font>E</font></h3>
          </div>
